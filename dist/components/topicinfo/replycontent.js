...
var ReplyContent = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ReplyContent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReplyContent.__proto__ || Object.getPrototypeOf(ReplyContent)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ReplyContent, [{
    ...
    value: function btnOK() {
      if (this.state.value) {
        this.props.onOKReplyContent && this.__triggerPropsFn("onOKReplyContent", [null].concat([this.state.value]));
      } else {
    ...
    value: function btnCancel() {
      this.props.onCancelReplyContent && this.__triggerPropsFn("onCancelReplyContent", [null].concat([]));
    }
  }, {
    key: "changeContent",
  ...
  "__fn_onCancelReplyContent": {
    "type": null,
    "value": null
  }
}, _class.$$events = ["changeContent", "btnOK", "btnCancel"], _temp2);
