...
var Panel = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Panel() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Panel.__proto__ || Object.getPrototypeOf(Panel)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "listData", "title"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Panel, [{
    ...
    value: function _createData() {
      ...
      var loopArray0 = listData.map(function (item) {
        item = {
