...
var User = (_dec = (0, _index3.connect)(function (store) {
  ...
  function User() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = User.__proto__ || Object.getPrototypeOf(User)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loginname", "avatar_url", "recent_topics", "recent_replies"], _this.state = {
      recent_topics: [],
      recent_replies: []
...
}, _class2.$$events = ["publishTopic"], _temp2)) || _class);
